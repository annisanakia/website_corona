...
<div class="bg-softblue">
    <div class="container">
    <br>
    <h4>Ubah Data Provinsi Penyebaran Covid-19</h4>
    <br>
    <div class="row">
        <form action="{{ url('home/covid19_case_update/'.$data->id) }}" method="post">
            {{csrf_field()}}
            <div class="col-md-6">
                <label class="form-label">Provinsi</label>
                <input type="text" name="provinsi" class="form-control" value="{{ $data->provinsi }}" placeholder="Masukkan nama provinsi">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="dirawat" class="form-control" value="{{ $data->dirawat }}" placeholder="Masukkan total yang dirawat">
                {!!$errors->first('dirawat', ' <span class="help-block text-danger">:message</span>')!!}
            </div>
            <div class="col-md-6">
                <br>
                <label class="form-label">Terkonfirmasi</label>
                <input type="number" name="terkonfirmasi" class="form-control" value="{{ $data->terkonfirmasi }}" placeholder="Masukkan total yang terkonfirmasi">
                {!!$errors->first('terkonfirmasi', ' <span class="help-block text-danger">:message</span>')!!}
            </div>
            <div class="col-md-6">
                <br>
                <label class="form-label">Sembuh</label>
                <input type="number" name="sembuh" class="form-control" value="{{ $data->sembuh }}" placeholder="Masukkan total yang sembuh">
                {!!$errors->first('sembuh', ' <span class="help-block text-danger">:message</span>')!!}
            </div>
            <div class="col-md-6">
                <br>
                <label class="form-label">Meninggal</label>
                <input type="number" name="meninggal" class="form-control" value="{{ $data->meninggal }}" placeholder="Masukkan total yang meninggal">
